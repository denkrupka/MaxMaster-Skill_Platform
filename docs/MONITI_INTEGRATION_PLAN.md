...
| Управление отделами с геозонами | ✅ полный | ✅ чтение | ✅ чтение | ❌ | ❌ |
...
| Дашборд "Команда сейчас" | ✅ все | ✅ все | ✅ свой отдел | ✅ своя бригада | ❌ |
...
- **HR** — доступ на чтение и редактирование
...
| Действие | COMPANY_ADMIN | HR | COORDINATOR | Остальные |
|---|---|---|---|---|
| Просмотр списка отделов | ✅ | ✅ | ✅ чтение | ❌ |
| Создание отдела | ✅ | ❌ | ❌ | ❌ |
...
- **Доступ к одобрению:** COMPANY_ADMIN, HR, COORDINATOR (свой отдел), BRIGADIR (своя бригада)
- Каждая заявка:
...
#### C.5.4 Модальное окно "Заявка на изменение" (для BRIGADIR, EMPLOYEE)
...
| Просмотр всех в компании | ✅ | ✅ | ✅ свой отдел* | ✅ своя бригада* | ❌ |
...
**Доступ:** COMPANY_ADMIN, HR (все заявки), COORDINATOR (заявки своего отдела), BRIGADIR (заявки своей бригады)
...
#### H.5.1 Страница "Табели" (для COMPANY_ADMIN, HR, COORDINATOR, BRIGADIR)
...
#### H.5.2 Страница "Отчёты" (для COMPANY_ADMIN, HR, COORDINATOR, BRIGADIR)
...
**Для COMPANY_ADMIN, HR, COORDINATOR, BRIGADIR:**
- Иконка: `FileSpreadsheet`, Текст: "Табели", Путь: `/company/timesheets`
- Иконка: `BarChart3`, Текст: "Отчёты", Путь: `/company/reports`
- COORDINATOR видит данные только по своему отделу, BRIGADIR — по своей бригаде
